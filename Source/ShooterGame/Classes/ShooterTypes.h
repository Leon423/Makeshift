...
// ADDED THIS
UENUM(BlueprintType)
namespace EWeaponClassification
{
	enum Type
	{
		WC_Rifle UMETA(DisplayName = "Rifle"),
		WC_RocketLauncher UMETA(DisplayName = "RocketLauncher"),
		WC_SMG UMETA(DisplayName = "SMG"),
		WC_Railshot UMETA(DisplayName = "Railshot"),
		WC_Sniper UMETA(DisplayName = "Sniper"),
		WC_PP UMETA(DisplayName = "PlasmaPistol"),
		WC_BeamGun UMETA(DisplayName = "BeamGun"),
		WC_Jimmy UMETA(DisplayName = "Jimmy"),
		WC_Pistol UMETA(DisplayName = "Pistol"),
		WC_GrenadeLauncher UMETA(DisplayName = "GrenadeLauncher")
	};
}
