...
public:
	...
	void ShowDialog(TWeakObjectPtr<ULocalPlayer> PlayerOwner, EShooterDialogType::Type DialogType, const FString& Message, const FString& Confirm, const FString& Cancel, const FOnClicked& OnConfirm, const FOnClicked& OnCancel);
	void HideDialog();
